...
const Icon: React.FC<IProps> = ({ name, className }) => {
  ...
  return (
    <i className={classNames('leading-4 inline-flex items-center justify-center', className)}>
      <SVGIcon width={svgWidth} height={svgHeight} fill={svgFill || 'currentColor'} stroke="none" className="block" />
    </i>
  );
}
